...
import Bearing_analysis_function_plotmark as fun
list1=[]
###input parameters ###
...
#    print(nwindows)
    ...
    result=fun.FTF(frqn,a2,a1)
    #print(result)
    result1=fun.BSF(frqn,a4,a3)
    #print(result) 
    result2=fun.OUTERRACE(frqn,a6,a5)
    #print(result2)
    result3=fun.INNERRACE(frqn,a8,a7)
    #print(result3)
