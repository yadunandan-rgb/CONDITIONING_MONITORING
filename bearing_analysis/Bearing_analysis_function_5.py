...
def FTF(input1,faultrange1,faultrange2):
    for element in input1:
        if element in range(int(faultrange1),int(faultrange2)):
            print("Their is first harmonic FTF fault")
            if element in range(int(2*faultrange1),int(2*faultrange2)):
                print("their is 2nd harmonic FTF fault")
                if element in range(int(3*faultrange1),int(3*faultrange2)):
                    print(" strong FTF fault")
        if element in range(int(2*faultrange1),int(2*faultrange1)):
            print("2nd harmonic FTF fault")
            if element in range(int(3*faultrange1),int(3*faultrange2)):
                print(" strong FTF fault")
        if element in range(int(3*faultrange1),int(3*faultrange2)):
            print("3rd harmonic FTF fault")
         
def BSF(input1,faultrange1,faultrange2):
    for element in input1:
        if element in range(int(faultrange1),int(faultrange2)):
            print("first harmonic BSF fault")
            if element in range(int(2*faultrange1),int(2*faultrange2)):
                print("2nd harmonic BSF fault")
                if element in range(int(3*faultrange1),int(3*faultrange2)):
                    print(" strong BSF fault")
        if element in range(int(2*faultrange1),int(2*faultrange1)):
            print("2nd harmonic BSF fault")
            if element in range(int(3*faultrange1),int(3*faultrange2)):
                print(" strong BSF fault")
        if element in range(int(3*faultrange1),int(3*faultrange2)):
            print("3rd harmonic BSF fault")
        
def OUTERRACE(input1,faultrange1,faultrange2):
    for element in input1:
        if element in range(int(faultrange1),int(faultrange2)):
            print("first harmonic OUTERRACE fault")
            if element in range(int(2*faultrange1),int(2*faultrange2)):
                print("2nd harmonic OUTERRACE fault")
                if element in range(int(3*faultrange1),int(3*faultrange2)):
                    print(" strong OUTERRACE fault")
        if element in range(int(2*faultrange1),int(2*faultrange1)):
            print("2nd harmonic OUTERRACE fault")
            if element in range(int(3*faultrange1),int(3*faultrange2)):
                print(" strong OUTERRACE fault")
        if element in range(int(3*faultrange1),int(3*faultrange2)):
            print("3rd harmonic OUTERRACE fault")
...
def INNERRACE(input1,faultrange1,faultrange2):
    for element in input1:
        if element in range(int(faultrange1),int(faultrange2)):
            print("first harmonic INNERACE fault")
            if element in range(int(2*faultrange1),int(2*faultrange2)):
                print("2nd harmonic INNERACE fault")
                if element in range(int(3*faultrange1),int(3*faultrange2)):
                    print(" strong INNERACE fault")
        if element in range(int(2*faultrange1),int(2*faultrange1)):
            print("2nd harmonic INNERACE fault")
            if element in range(int(3*faultrange1),int(3*faultrange2)):
                print(" strong INNERACE fault")
        if element in range(int(3*faultrange1),int(3*faultrange2)):
            print("3rd harmonic INNERACE fault")
