...
def faultrange(FTFFinal,BSFFinal,BPFOFinal,BPFIFinal):
    ...
    FTFFinalrange1=FTFFinal+FTFFinalrangelimit
    FTFFinalrange2=FTFFinal-FTFFinalrangelimit
    
    BPFIFinalrangelimit=BPFIFinal*0.2
    BPFIFinalrange1=BPFIFinal+BPFIFinalrangelimit
    BPFIFinalrange2=BPFIFinal-BPFIFinalrangelimit
